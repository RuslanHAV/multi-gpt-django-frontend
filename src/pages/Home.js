...
const Home = () => {
    ...
    const handleEmbedding = async () => {
        const rlt = await axios.post(process.env.server_api_url + "/langchain/url_embedding", { site_url: url });
        console.log(rlt);
    };
    ...
    const handleProcess = async () => {
        const rlt = await axios.post(process.env.server_api_url + "/langchain/chat", { site_url: url, userPrompts: userPrompts });
        console.log(rlt);
    };
    ...
    const handleSubmit = async (evt) => {
        ...
        console.log("upload = ", upload);
        // const res = await fetch(process.env.server_api_url + "/langchain/pdf_embedding", {
        //     method: "POST",
        //     body: data,
        // });
